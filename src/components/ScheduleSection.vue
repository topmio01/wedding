...
const items = [
  { time: '07:09 น.', caption: 'พิธีสงฆ์', side: 'left' },
  { time: '08:29 น.', caption: 'พิธีแห่ขันหมาก', side: 'right' },
  { time: '09:39 น.', caption: 'พิธีรับไหว้', side: 'left'},
  { time: '10:09 น.', caption: 'พิธีหลั่งน้ำพระพุทธมนต์', side: 'right' },
  { time: '12:00 น.', caption: 'งานเลี้ยงฉลองมงคลสมรส', side: 'left'},
